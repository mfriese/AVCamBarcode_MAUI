...
namespace AVCamBarcode {
	...
	public partial class PreviewView : UIView, IUIGestureRecognizerDelegate {
		...
		public void SetRegionOfInterestWithProposedRegionOfInterest (CGRect proposedRegionOfInterest)
		{
			...
			if (RegionOfInterestOverride != CGRect.Null)
				RegionOfInterest = RegionOfInterestOverride;
		...
		{
            // Touch events start, that means the preset must now be disposed.
            this.RegionOfInterestOverride = CGRect.Null;
        ...
        /// </summary>
        public CGRect RegionOfInterestOverride { get; set; } = CGRect.Null;
    }
}
